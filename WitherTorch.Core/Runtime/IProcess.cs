...
public delegate void MessageReceivedEventHandler(object? sender, in MessageReceivedEventArgs e);
...
public readonly struct MessageReceivedEventArgs
{
    ...
    /// <param name="message">此事件的訊息內容</param>
    public MessageReceivedEventArgs(bool isError, string message)
    {
        _isError = isError;
        _message = message;
    }
